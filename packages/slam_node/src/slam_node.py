...
class SLAMNode(DTROS):
    ...
    def __init__(self, node_name):
        ...
        popen_env = {'LD_LIBRARY_PATH': src_path + '/lib'}
    ...
    def callback(self, msg):
        ...
        if self.im_count % 2 == 0:
            ...
            send_request(self.slam_server, im, timestamp)
            ...
            t.child_frame_id = f'{HOST_NAME}/odometry'
            t.transform.translation = geometry_msgs.msg.Vector3(pose_mat[3, 0].item(), pose_mat[3, 1].item(), pose_mat[3, 2].item())
